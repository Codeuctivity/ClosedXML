...
namespace ClosedXML.Tests.Excel.CalcEngine
{
    ...
    public class DateAndTimeTests
    {
        ...
        public void Datevalue()
        {
            ...
            Assert.That(actual, Is.EqualTo(39682));
        }
        ...
        public void Days()
        {
            ...
            Assert.That(actual, Is.EqualTo(8981));
        ...
        public void EDate_Negative1()
        {
            ...
            Assert.That(actual, Is.EqualTo(new DateTime(2008, 2, 1)));
        }
        ...
        public void EDate_Negative2()
        {
            ...
            Assert.That(actual, Is.EqualTo(new DateTime(2008, 2, 29)));
        }
        ...
        {
            var actual = XLWorkbook.EvaluateExpr("EDate(\"3/1/2008\", 1)");
            Assert.That(actual, Is.EqualTo(new DateTime(2008, 4, 1)));
        }
        ...
        {
            var actual = XLWorkbook.EvaluateExpr("EDate(\"3/31/2008\", 1)");
            Assert.That(actual, Is.EqualTo(new DateTime(2008, 4, 30)));
        }
        ...
        public void Networkdays_MultipleHolidaysGiven()
        {
            ...
            Assert.That(actual, Is.EqualTo(105));
        }
        ...
        public void Time()
        {
            ...
            Assert.That(actual, Is.EqualTo(new TimeSpan(1, 2, 3)));
        }
        ...
        public void TimeValue1()
        {
            ...
            Assert.That(XLHelper.AreEqual(0.1, (double)actual), Is.True);
        }
        ...
        public void TimeValue2()
        {
            ...
            Assert.That(XLHelper.AreEqual(0.27430555555555558, (double)actual), Is.True);
        }
        ...
        public void Today()
        {
            ...
            Assert.That(actual, Is.EqualTo(DateTime.Now.Date));
        }
        ...
        {
            Assert.That(XLWorkbook.EvaluateExpr("Weeknum(\"3/9/2000\", 1)"), Is.EqualTo(11));
        }

        [Test]
        public void Weeknum_10()
        {
            Assert.That(XLWorkbook.EvaluateExpr("Weeknum(\"3/9/2004\", 2)"), Is.EqualTo(11));
        }

        [Test]
        public void Weeknum_11()
        {
            Assert.That(XLWorkbook.EvaluateExpr("Weeknum(\"3/9/2005\", 1)"), Is.EqualTo(11));
        }

        [Test]
        public void Weeknum_12()
        {
            Assert.That(XLWorkbook.EvaluateExpr("Weeknum(\"3/9/2005\", 2)"), Is.EqualTo(11));
        }

        [Test]
        public void Weeknum_13()
        {
            Assert.That(XLWorkbook.EvaluateExpr("Weeknum(\"3/9/2006\", 1)"), Is.EqualTo(10));
        }

        [Test]
        public void Weeknum_14()
        {
            Assert.That(XLWorkbook.EvaluateExpr("Weeknum(\"3/9/2006\", 2)"), Is.EqualTo(11));
        }

        [Test]
        public void Weeknum_15()
        {
            Assert.That(XLWorkbook.EvaluateExpr("Weeknum(\"3/9/2007\", 1)"), Is.EqualTo(10));
        }

        [Test]
        public void Weeknum_16()
        {
            Assert.That(XLWorkbook.EvaluateExpr("Weeknum(\"3/9/2007\", 2)"), Is.EqualTo(10));
        }

        [Test]
        public void Weeknum_17()
        {
            Assert.That(XLWorkbook.EvaluateExpr("Weeknum(\"3/9/2008\", 1)"), Is.EqualTo(11));
        }

        [Test]
        public void Weeknum_18()
        {
            Assert.That(XLWorkbook.EvaluateExpr("Weeknum(\"3/9/2008\", 2)"), Is.EqualTo(10));
        }

        [Test]
        public void Weeknum_19()
        {
            Assert.That(XLWorkbook.EvaluateExpr("Weeknum(\"3/9/2009\", 1)"), Is.EqualTo(11));
        }

        [Test]
        public void Weeknum_2()
        {
            Assert.That(XLWorkbook.EvaluateExpr("Weeknum(\"3/9/2000\", 2)"), Is.EqualTo(11));
        }

        [Test]
        public void Weeknum_20()
        {
            Assert.That(XLWorkbook.EvaluateExpr("Weeknum(\"3/9/2009\", 2)"), Is.EqualTo(11));
        }

        [Test]
        public void Weeknum_3()
        {
            Assert.That(XLWorkbook.EvaluateExpr("Weeknum(\"3/9/2001\", 1)"), Is.EqualTo(10));
        }

        [Test]
        public void Weeknum_4()
        {
            Assert.That(XLWorkbook.EvaluateExpr("Weeknum(\"3/9/2001\", 2)"), Is.EqualTo(10));
        }

        [Test]
        public void Weeknum_5()
        {
            Assert.That(XLWorkbook.EvaluateExpr("Weeknum(\"3/9/2002\", 1)"), Is.EqualTo(10));
        }

        [Test]
        public void Weeknum_6()
        {
            Assert.That(XLWorkbook.EvaluateExpr("Weeknum(\"3/9/2002\", 2)"), Is.EqualTo(10));
        }

        [Test]
        public void Weeknum_7()
        {
            Assert.That(XLWorkbook.EvaluateExpr("Weeknum(\"3/9/2003\", 1)"), Is.EqualTo(11));
        }

        [Test]
        public void Weeknum_8()
        {
            Assert.That(XLWorkbook.EvaluateExpr("Weeknum(\"3/9/2003\", 2)"), Is.EqualTo(10));
        }

        [Test]
        public void Weeknum_9()
        {
            Assert.That(XLWorkbook.EvaluateExpr("Weeknum(\"3/9/2004\", 1)"), Is.EqualTo(11));
        }
        ...
        public void Workdays_MultipleHolidaysGiven()
        {
            ...
            Assert.That(actual, Is.EqualTo(new DateTime(2009, 5, 5)));
        }
        ...
        public void Workdays_NoHolidaysGiven()
        {
            ...
            Assert.That(actual, Is.EqualTo(new DateTime(2009, 4, 30)));

            actual = XLWorkbook.EvaluateExpr("Workday(\"2016-01-01\", -10)");
            Assert.That(actual, Is.EqualTo(new DateTime(2015, 12, 18)));
        }
        ...
        public void Workdays_OneHolidaysGiven()
        {
            ...
            Assert.That(actual, Is.EqualTo(new DateTime(2009, 5, 4)));
        }
        ...
        public void Year()
        {
            ...
            Assert.That(actual, Is.EqualTo(2008));
        }
        ...
        public void Yearfrac_1_base1()
        {
            ...
            Assert.That(XLHelper.AreEqual(0.24590163934426229, (double)actual), Is.True);
        }
        ...
        public void Yearfrac_1_base3()
        {
            ...
            Assert.That(XLHelper.AreEqual(0.24657534246575341, (double)actual), Is.True);
        }
        ...
        public void Yearfrac_1_base4()
        {
            ...
            Assert.That(XLHelper.AreEqual(0.24722222222222223, (double)actual), Is.True);
        }
        ...
        public void Yearfrac_2_base0()
        {
            ...
            Assert.That(XLHelper.AreEqual(5.25, (double)actual), Is.True);
        }
        ...
        public void Yearfrac_2_base1()
        {
            ...
            Assert.That(XLHelper.AreEqual(5.24452554744526, (double)actual), Is.True);
        }
        ...
        public void Yearfrac_2_base2()
        {
            ...
            Assert.That(XLHelper.AreEqual(5.32222222222222, (double)actual), Is.True);
        }
        ...
        public void Yearfrac_2_base3()
        {
            ...
            Assert.That(XLHelper.AreEqual(5.24931506849315, (double)actual), Is.True);
        }
        ...
        public void Yearfrac_2_base4()
        {
            ...
            Assert.That(XLHelper.AreEqual(5.24722222222222, (double)actual), Is.True);
        }
    }
}